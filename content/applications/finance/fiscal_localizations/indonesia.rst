...
.. screenshot:: finance-fl-indonesia-efaktur-product
   :menu: Accounting ‣ Customers ‣ Products ‣ (a product) ‣ Accounting tab
   :shows: A product form with the "Indonesian Localization" section showing the "E-Faktur Product Code" field set to "000000 - Barang".
   :highlight: The "E-Faktur Product Code" field.
   :data: Demo company "YourCompany ID", Indonesian localization installed.
...
.. screenshot:: finance-fl-indonesia-efaktur-uom
   :menu: Inventory ‣ Configuration ‣ UoM Categories ‣ (a category)
   :shows: A UoM category form with the "E-Faktur UoM code" field selected (e.g. "UM.0018 - Unit").
   :highlight: The "E-Faktur UoM code" field.
   :data: Demo company "YourCompany ID", Indonesian localization installed.
   :module: l10n_id_efaktur_coretax
   :notes: English UI, light theme, 1440px width.
...
section is populated automatically.
   ...
   .. screenshot:: finance-fl-indonesia-faktur-invoice-confirmed
      :menu: Accounting ‣ Customers ‣ Invoices ‣ (a posted invoice for a PKP customer)
      :shows: A posted customer invoice, Other Info tab, "Electronic Tax" section: "Kode Transaksi" selected and the "e-Faktur Document (Coretax)" field populated with the generated XML file after using Actions ‣ Download e-faktur.
      :highlight: The "e-Faktur Document (Coretax)" field.
      :data: Demo company "YourCompany ID", Indonesian localization installed. Customer with "Is PKP" enabled.
      :module: l10n_id_efaktur_coretax
      :notes: English UI, light theme, 1440px width.
...
.. screenshot:: finance-fl-indonesia-qris-setup
   :menu: Contacts ‣ Configuration ‣ Bank Accounts ‣ (the bank account)
   :shows: A bank account form with "Proxy Type" set to "QRIS" and the "Proxy Value" (QRIS merchant string) filled in, and "Include Reference" ticked.
   :highlight: The "Proxy Type" and "Proxy Value" fields.
   :data: Demo company "YourCompany ID", Indonesian localization installed.
   :module: l10n_id, account_qr_code_emv
   :notes: English UI, light theme, 1440px width.
...
.. screenshot:: finance-fl-indonesia-journal-bank-config
...
.. screenshot:: finance-fl-indonesia-invoice-qris

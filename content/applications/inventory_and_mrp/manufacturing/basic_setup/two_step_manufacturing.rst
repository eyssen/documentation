...
.. tip::
   ...
   .. screenshot:: manufacturing-two-step-warehouse-type
      :menu: Inventory ‣ Configuration ‣ Warehouses ‣ (warehouse)
      :shows: Warehouse configuration page, "Warehouse Configuration" tab, with the "Manufacture" radio field showing its three options and "Pick components and then manufacture (2 steps)" selected.
...
.. screenshot:: manufacturing-two-step-mo-breadcrumb
   :menu: Manufacturing ‣ Operations ‣ Manufacturing Orders ‣ (MO) ‣ Transfers ‣ pick components transfer
   :shows: The validated pick components transfer with the "WH/MO/00001" breadcrumb link at the top, next to "WH/PC/00001".
   :highlight: The "WH/MO/00001" breadcrumb (red frame).
   :data: MO "WH/MO/00001" for product "Chair"; transfer "WH/PC/00001".
   :module: mrp
...
.. screenshot:: manufacturing-two-step-start-button
...
.. screenshot:: manufacturing-two-step-done-button
   :menu: Manufacturing ‣ Operations ‣ Manufacturing Orders ‣ (MO) ‣ Work Orders tab
